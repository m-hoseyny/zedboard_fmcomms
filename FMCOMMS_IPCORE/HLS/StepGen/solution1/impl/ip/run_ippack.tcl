...
set IPName      "stepGen"
set Version     "1.0"
set DisplayName "Stepgen"
set Revision    "1809011254"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {}
        memories "out_vec {base_address 1024 range 1024}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_CRTL_BUS"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 257 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/ArzhangJunior/Desktop/HLS/StepGen/stepGen.cpp}
if {$enable_xo_gen} {
