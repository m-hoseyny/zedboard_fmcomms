...
`define AUTOTB_DUT      stepGen
`define AUTOTB_DUT_INST AESL_inst_stepGen
`define AUTOTB_TOP      apatb_stepGen_top
`define AUTOTB_LAT_RESULT_FILE "stepGen.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "stepGen.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_stepGen_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_TRANSACTION_NUM  1
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00
`define LENGTH_out_vec 256

`define   AESL_DEPTH_out_vec 1
`define AUTOTB_TVOUT_out_vec  "../tv/cdatafile/c.stepGen.autotvout_out_vec.dat"
`define AUTOTB_TVOUT_out_vec_out_wrapc  "../tv/rtldatafile/rtl.stepGen.autotvout_out_vec.dat"
