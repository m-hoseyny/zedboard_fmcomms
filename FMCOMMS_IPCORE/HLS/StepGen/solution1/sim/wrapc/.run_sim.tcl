...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "stepGen.autotvin.dat"
	set constFileTvOut       "stepGen.autotvout.dat"
	set constFileHdlTvIn     "stepGen.autohdltvin.dat"
	set constFileHdlTvOut    "stepGen.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
