...
$(ObjDir)/test_stepGen.cpp_pre.cpp.tb.o : test_stepGen.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_stepGen.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/stepGen.cpp_pre.cpp.tb.o : stepGen.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling stepGen.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
