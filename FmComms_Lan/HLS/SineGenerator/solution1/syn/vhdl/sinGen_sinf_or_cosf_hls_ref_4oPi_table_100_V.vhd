...
entity sinGen_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom is 
    generic(
             dwidth     : integer := 100; 
             awidth     : integer := 4; 
             mem_size    : integer := 13
...
architecture rtl of sinGen_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom is 
...
entity sinGen_sinf_or_cosf_hls_ref_4oPi_table_100_V is
    generic (
...
architecture arch of sinGen_sinf_or_cosf_hls_ref_4oPi_table_100_V is
    component sinGen_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    sinGen_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom_U :  component sinGen_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
