...
`define AUTOTB_DUT      sinGen
`define AUTOTB_DUT_INST AESL_inst_sinGen
`define AUTOTB_TOP      apatb_sinGen_top
`define AUTOTB_LAT_RESULT_FILE "sinGen.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "sinGen.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_sinGen_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_TRANSACTION_NUM  1
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00
`define LENGTH_cycle 1
`define LENGTH_amp 1
`define LENGTH_binOffset 1
`define LENGTH_outIQ 256

`define   AESL_DEPTH_Fs 1
`define   AESL_DEPTH_cycle 1
`define   AESL_DEPTH_amp 1
`define   AESL_DEPTH_binOffset 1
`define   AESL_DEPTH_outIQ 1
`define AUTOTB_TVIN_cycle  "./c.sinGen.autotvin_cycle.dat"
`define AUTOTB_TVIN_amp  "./c.sinGen.autotvin_amp.dat"
`define AUTOTB_TVIN_binOffset  "./c.sinGen.autotvin_binOffset.dat"
`define AUTOTB_TVIN_cycle_out_wrapc  "./rtl.sinGen.autotvin_cycle.dat"
`define AUTOTB_TVIN_amp_out_wrapc  "./rtl.sinGen.autotvin_amp.dat"
`define AUTOTB_TVIN_binOffset_out_wrapc  "./rtl.sinGen.autotvin_binOffset.dat"
`define AUTOTB_TVOUT_outIQ  "./c.sinGen.autotvout_outIQ.dat"
`define AUTOTB_TVOUT_outIQ_out_wrapc  "./impl_rtl.sinGen.autotvout_outIQ.dat"
...
AESL_axi_slave_CRTLS AESL_AXI_SLAVE_CRTLS(
    ...
    .TRAN_CRTLS_interrupt  (interrupt),
...
reg dump_tvout_finish_outIQ;

initial begin : dump_tvout_runtime_sign_outIQ
	integer fp;
	dump_tvout_finish_outIQ = 0;
	fp = $fopen(`AUTOTB_TVOUT_outIQ_out_wrapc, "w");
	if (fp == 0) begin
		$display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_outIQ_out_wrapc);
		$display("ERROR: Simulation using HLS TB failed.");
		$finish;
	end
	$fdisplay(fp,"[[[runtime]]]");
	...
	@ (posedge AESL_clock);
	@ (posedge AESL_clock);
	fp = $fopen(`AUTOTB_TVOUT_outIQ_out_wrapc, "a");
	if (fp == 0) begin
		$display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_outIQ_out_wrapc);
		$display("ERROR: Simulation using HLS TB failed.");
		$finish;
