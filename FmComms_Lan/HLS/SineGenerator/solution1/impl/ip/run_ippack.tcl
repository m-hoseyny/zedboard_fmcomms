...
set IPName      "sinGen"
set Version     "1.0"
set DisplayName "Singen"
set Revision    "1809031427"
...
set Interfaces {
    s_axi_CRTLS {
        ...
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 Fs W 0x0 "Data signal of Fs" {{0 32 Fs W 0 "Bit 31 to 0 Data signal of Fs"}}} {0x18 cycle W 0x0 "Data signal of cycle" {{0 32 cycle W 0 "Bit 31 to 0 Data signal of cycle"}}} {0x20 amp W 0x0 "Data signal of amp" {{0 32 amp W 0 "Bit 31 to 0 Data signal of amp"}}} {0x28 binOffset W 0x0 "Data signal of binOffset" {{0 32 binOffset W 0 "Bit 31 to 0 Data signal of binOffset"}}}}
        memories "outIQ {base_address 1024 range 1024}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 16921 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/ArzhangJunior/Desktop/jso/SineGenerator/core.cpp}
if {$enable_xo_gen} {
