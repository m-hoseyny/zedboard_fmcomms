...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.CLKOUT1_JITTER {125.247} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {125.000}  ] $clk_wiz_0
  ...
  set_property -dict [ list CONFIG.C_CACHE_BYTE_SIZE {65536} CONFIG.C_DCACHE_ALWAYS_USED {1} CONFIG.C_DCACHE_BASEADDR {0x80000000} CONFIG.C_DCACHE_BYTE_SIZE {65536} CONFIG.C_DCACHE_HIGHADDR {0xBFFFFFFF} CONFIG.C_DCACHE_LINE_LEN {8} CONFIG.C_DCACHE_USE_WRITEBACK {1} CONFIG.C_DCACHE_VICTIMS {0} CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_D_AXI {1} CONFIG.C_D_LMB {1} CONFIG.C_FREQ {100000000} CONFIG.C_ICACHE_ALWAYS_USED {1} CONFIG.C_ICACHE_BASEADDR {0x80000000} CONFIG.C_ICACHE_HIGHADDR {0xBFFFFFFF} CONFIG.C_ICACHE_LINE_LEN {8} CONFIG.C_ICACHE_STREAMS {0} CONFIG.C_ICACHE_VICTIMS {0} CONFIG.C_I_LMB {1} CONFIG.C_M_AXI_DC_USER_SIGNALS {0} CONFIG.C_M_AXI_IC_USER_SIGNALS {0} CONFIG.C_USE_BARREL {1} CONFIG.C_USE_BRANCH_TARGET_CACHE {1} CONFIG.C_USE_DCACHE {1} CONFIG.C_USE_DIV {1} CONFIG.C_USE_EXT_BRK {0} CONFIG.C_USE_EXT_NM_BRK {0} CONFIG.C_USE_FPU {2} CONFIG.C_USE_HW_MUL {2} CONFIG.C_USE_ICACHE {1} CONFIG.C_USE_INTERRUPT {2} CONFIG.C_USE_MSR_INSTR {1} CONFIG.C_USE_PCMP_INSTR {1} CONFIG.G_TEMPLATE_LIST {2}  ] $microblaze_0
