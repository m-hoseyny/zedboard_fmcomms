...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ETHERNET_BOARD_INTERFACE {rgmii} CONFIG.MDIO_BOARD_INTERFACE {mdio_io} CONFIG.PHYRST_BOARD_INTERFACE {phy_reset_out} CONFIG.RXCSUM {Full} CONFIG.RXMEM {32k} CONFIG.TXCSUM {Full} CONFIG.TXMEM {32k} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_0
  ...
  set_property -dict [ list CONFIG.NUM_MI {2} CONFIG.NUM_SI {5} CONFIG.S00_HAS_DATA_FIFO {2} CONFIG.S01_HAS_DATA_FIFO {2} CONFIG.S02_HAS_DATA_FIFO {2} CONFIG.S03_HAS_DATA_FIFO {2} CONFIG.S04_HAS_DATA_FIFO {2} CONFIG.STRATEGY {2}  ] $axi_mem_intercon
  ...
  set_property -dict [ list CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {125.000}  ] $clk_wiz_0
  ...
  set_property -dict [ list CONFIG.C_CACHE_BYTE_SIZE {32768} CONFIG.C_DCACHE_ALWAYS_USED {1} CONFIG.C_DCACHE_BASEADDR {0x80000000} CONFIG.C_DCACHE_BYTE_SIZE {32768} CONFIG.C_DCACHE_HIGHADDR {0xBFFFFFFF} CONFIG.C_DCACHE_USE_WRITEBACK {1} CONFIG.C_DCACHE_VICTIMS {4} CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_D_AXI {1} CONFIG.C_D_LMB {1} CONFIG.C_FAULT_TOLERANT {0} CONFIG.C_ICACHE_ALWAYS_USED {1} CONFIG.C_ICACHE_BASEADDR {0x80000000} CONFIG.C_ICACHE_HIGHADDR {0xBFFFFFFF} CONFIG.C_ICACHE_STREAMS {1} CONFIG.C_ICACHE_VICTIMS {4} CONFIG.C_I_LMB {1} CONFIG.C_USE_DCACHE {1} CONFIG.C_USE_ICACHE {1} CONFIG.C_USE_INTERRUPT {2} CONFIG.G_TEMPLATE_LIST {2}  ] $microblaze_0
  ...
  connect_bd_intf_net -intf_net axi_ethernet_0_mdio [get_bd_intf_ports mdio] [get_bd_intf_pins axi_ethernet_0/mdio_io]
